                                ...
                                <main className="flex-1 pt-32">
                                                <div className="container mx-auto px-4 max-w-6xl">
                                                    ...
                                                    <div className="text-center py-20">
                                                                                    <p className="text-muted-foreground">Failed to load products</p>p>
                                                    </div>div>
                                                ) : hasProducts ? (
                                                    <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                                                    ...
                                                    <div className="text-center py-20">
                                                                                    ...
                                                                                    <p className="text-muted-foreground">No products available yet</p>p>
                                                                                    <p className="text-sm text-muted-foreground/60 mt-2">Check back soon for new arrivals</p>p>
                                                    </div>div>
                                                                                            )}
                                                                    </div>div>
                                                </div>div>
